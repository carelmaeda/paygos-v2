...
export const metadata: Metadata = {
  title: "Technology Scaling Success Story | Paygos",
  description: "Learn how technology companies scale operations with Paygos. Explore rapid growth enablement, scalable infrastructure, and efficient expansion strategies.",
  keywords: ["technology scaling", "business growth", "scalability", "tech expansion", "growth automation", "scaling operations", "technology growth"],
  openGraph: {
    title: "Technology Scaling Success Story | Paygos",
    description: "Learn how technology companies scale operations with Paygos. Explore rapid growth enablement, scalable infrastructure, and efficient expansion strategies.",
    url: "https://www.paygos.ca/customers/technology-scale",
    siteName: "Paygos",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Paygos Technology Scaling Success Story",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  alternates: {
    canonical: "https://www.paygos.ca/customers/technology-scale",
  },
}
