  ...
  return (
    <main className="py-16 md:py-24">
      <div className="container">
        {/* Hero Section */}
        <div className="mb-12 rounded-lg bg-white text-center">
        ...
        <div className="relative mx-auto mb-12 h-96 max-w-4xl overflow-hidden rounded-lg bg-gray-100">
          <Image
            src="/solutions/fsa.svg"
            alt="Field Sales Automation"
            fill
        ...
        <div className="mx-auto mb-16 max-w-3xl">
          ...
          <p className="text-lg text-gray-600">
            Add your custom content here. You can add any HTML/Tailwind markup
            you want.
          </p>
        </div>
