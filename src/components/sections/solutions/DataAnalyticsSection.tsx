...
const ANALYTICS_FEATURES = [
  {
    ...
    icon: Activity,
    image: "https://images.unsplash.com/photo-1520333789090-1afc82db536a?w=800&q=75",
    slug: "live-ops",
  ...
  },
  {
    ...
    icon: BrainCircuit,
    image: "https://images.unsplash.com/photo-1739036868260-c26b292cd85d?w=800&q=75",
    slug: "predictive",
    className: "md:col-span-2 md:row-span-1 min-h-[200px]",
  },
  {
    ...
    icon: FileText,
    image: "https://images.unsplash.com/photo-1590098563176-07884b06d7f7?w=800&q=75",
    slug: "history",
  ...
  },
  {
    ...
    icon: BarChart3,
    image: "https://images.unsplash.com/photo-1599202889720-cd3c0833efa1?w=800&q=75",
    slug: "market-intel",
    className: "md:col-span-2 md:row-span-1 min-h-[200px]",
  },
  {
  ...
  },
  {
    ...
    icon: Smartphone,
    image: "https://images.unsplash.com/photo-1608222351212-18fe0ec7b13b?w=800&q=75",
    slug: "reporting",
